        ...
        <div className=' p-5 relative'>
            ...
            {showType == "dimention" && <div>
                <div className=' flex justify-around gap-4'>
                    <div className=' flex flex-col gap-3 '>
                        ...
                        <input type="number" name="height" id="height" className=' bg-gray-800 outline-none p-1 rounded-md' placeholder='height' />
                    </div>
                    <div className=' flex flex-col gap-3 '>
                        ...
                        <input type="number" name="width" id="" className=' bg-gray-800 outline-none p-1 rounded-md' placeholder='width' />
                    </div>
                </div>
            ...
            {showType == "percentage" && <div className=' py-6'>
                ...
                <div className=' flex bg-gray-800 p-5 rounded-lg'>
                    <input type="range" name="" id="" min={0} max={200} onChange={(e) => setrange(e.target.value)} className=' w-[80%] bg-blue-400 ' />
            ...
            <div >
                ...
                <button className=' bg-blue-400 w-full p-2 rounded-md text-xl font-semibold outline-none my-10'>
                    Update Image
                </button>
            </div>
        </div>
